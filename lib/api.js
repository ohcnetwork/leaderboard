...
export function getContributorsSortedByWeekSummary(detail = false) {
  return getContributors(detail).sort(
    (a, b) => b.weekSummary.points - a.highlights.points
  );
}

export function getContributorsSortedByMonthSummary(detail = false) {
  return getContributors(detail).sort(
    (a, b) => b.monthSummary.points - a.highlights.points
  );
}

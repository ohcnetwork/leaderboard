  ...
  return (
    ...
    >
      <div className="flex shrink-0 items-center  md:space-y-2 xl:space-y-1">
        <div className="z-10 flex h-16 w-16 shrink-0 items-center rounded-full md:h-20 md:w-20 md:p-1">
          <Image
      ...
      <p className="max-h-64 scale-75 text-xs text-secondary-700 dark:text-secondary-300 ">

...
export const docs = await create.docs(
  "docs",
  "docs",
  { "meta.json": __fd_glob_0, "getting-started/meta.json": __fd_glob_1 },
  {
    "api-reference.mdx": __fd_glob_2,
    "configuration-reference.mdx": __fd_glob_3,
    "contributing.mdx": __fd_glob_4,
    "customization.mdx": __fd_glob_5,
    "data-management.mdx": __fd_glob_6,
    "deployment.mdx": __fd_glob_7,
    "index.mdx": __fd_glob_8,
    "scrapers.mdx": __fd_glob_9,
    "testing.mdx": __fd_glob_10,
    "troubleshooting.mdx": __fd_glob_11,
    "getting-started/configuration.mdx": __fd_glob_12,

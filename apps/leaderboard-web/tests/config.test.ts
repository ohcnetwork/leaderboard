  ...
  describe("Invalid Configurations - Missing Required Fields", () => {
    it("should reject configuration with missing org required fields", () => {
      ...
      try {
        ...
        expect(hasValidationError(message, "org.description", "Required")).toBe(true);
        expect(hasValidationError(message, "org.url", "Required")).toBe(true);
        expect(hasValidationError(message, "org.logo_url", "Required")).toBe(true);
      }
    });
    ...
    it("should reject configuration with missing meta required fields", () => {
      ...
      try {
        ...
        expect(hasValidationError(message, "meta.description", "Required")).toBe(true);
        expect(hasValidationError(message, "meta.image_url", "Required")).toBe(true);
        expect(hasValidationError(message, "meta.site_url", "Required")).toBe(true);
        expect(hasValidationError(message, "meta.favicon_url", "Required")).toBe(true);
      }
    });
  ...
  describe("Social Profiles Configuration Validation", () => {
    ...
    it("should reject social profile with missing icon field", () => {
      ...
      try {
        ...
        const message = (error as Error).message;
        expect(message).toContain("social_profiles");

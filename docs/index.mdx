...
- [Data Explorer](/docs/data-explorer) — query the database with SQL directly in the browser

### 🤖 AI Integration

- [MCP Server](/docs/mcp-server) — query leaderboard data with AI assistants via Model Context Protocol
- 20+ query tools for comprehensive data access
- Support for Claude Desktop and other MCP clients
- Read-only, secure API for AI interactions
...
- [Data Explorer](/docs/data-explorer)

...
export default async function Page() {
  ...
  return (
    <>
      ...
      <div className="bg-secondary-100/50 dark:bg-secondary-800/50 sticky top-40  h-fit w-full rounded-lg border border-secondary-100 shadow-lg  dark:border-secondary-800 lg:fixed lg:right-28 lg:top-20 lg:w-[23%]">
